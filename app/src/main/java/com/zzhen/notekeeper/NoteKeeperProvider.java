...
import com.zzhen.notekeeper.NoteKeeperProviderContract.CoursesIdColumns;
...
public class NoteKeeperProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriMatch) {
            ...
            case NOTES:
                ...
                break;
            case NOTES_EXPANDED:
                // throws exception saying that this is a read-only table
            case NOTES_ROW:
    ...
    public String getType(Uri uri) {
        ...
        switch (uriMatch) {
            case COURSES:
                // vnd.android.cursor.dir/vnd.com.zzhen.notekeeper.provider.courses
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatch) {
            case NOTES:
                ...
                // content://com.zzhen.notekeeper.provider/notes/1
